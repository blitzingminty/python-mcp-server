# src/mcp_project_tools.py
# Contains MCP tool definitions for managing projects.
...
async def create_project(
    name: str, path: str, description: Optional[str] = None, is_active: bool = False, ctx: Optional[Context[Any, Any]] = None
) -> Dict[str, Any]:
...
@mcp_instance.tool()
async def get_project(project_id: int, ctx: Optional[Context[Any, Any]]) -> Dict[str, Any]:
...
async def update_project(
    ...
    path: Optional[str] = None, is_active: Optional[bool] = None, ctx: Optional[Context[Any, Any]] = None
) -> Dict[str, Any]:
...
@mcp_instance.tool()
async def delete_project(project_id: int, ctx: Optional[Context[Any, Any]]) -> Dict[str, Any]:
    """Deletes a project."""
...
@mcp_instance.tool()
async def set_active_project(project_id: int, ctx: Optional[Context[Any, Any]]) -> Dict[str, Any]:
