...
# Refactor document MCP tools to use the same session acquisition pattern as project tools

@mcp_instance.tool(name="list_documents", description="List all documents")
async def list_documents_v2(project_id: int | None = None):
...
async def create_document_v2(project_id: int, name: str, path: str, content: str, type: str, version: str = "1.0.0"):
...
async def get_document_v2(document_id: int):
...
async def update_document_v2(document_id: int, name: str | None = None, path: str | None = None, type: str | None = None):
...
async def delete_document_v2(document_id: int):
...
async def add_document_tag_v2(document_id: int, tag_name: str):
...
async def remove_document_tag_v2(document_id: int, tag_name: str):
...
async def list_document_versions_v2(document_id: int):
...
async def get_document_version_v2(version_id: int):
...
async def create_document_version_v2(document_id: int, content: str, version_string: str):
...
async def delete_document_version_v2(version_id: int):
